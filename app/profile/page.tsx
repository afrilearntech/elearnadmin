...
import { User, changePassword, ChangePasswordRequest } from "@/lib/api/auth";
...
const getRoleDisplay = (role: string) => {
  ...
  if (roleUpper.includes("CREATOR")) {
    return "Content Creator";
  }
  if (roleUpper.includes("VALIDATOR")) {
                ...
                <div className="mt-3">
                  <span className={`inline-flex items-center rounded-full px-3 py-1 text-sm font-medium ${
                    user.role.toUpperCase() === "ADMIN" || user.role.toUpperCase() === "ADMINISTRATOR"
                      ...
                      : user.role.toUpperCase().includes("VALIDATOR")
