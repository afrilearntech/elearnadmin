...
const navItems: NavItem[] = [
  ...
  { href: "/users", label: "Users", icon: "solar:users-group-two-rounded-bold" },
  { href: "/content-managers", label: "Content Managers", icon: "solar:user-bold" },
  { href: "/students", label: "Students", icon: "solar:book-bookmark-bold" },
  { href: "/teachers", label: "Teachers", icon: "solar:users-group-rounded-bold" },
  { href: "/parents", label: "Parents", icon: "solar:users-group-two-rounded-bold-duotone" },
  { href: "/subjects", label: "Subjects", icon: "solar:book-2-bold" },
  { href: "/lessons", label: "Lessons", icon: "solar:play-circle-bold" },
  { href: "/games", label: "Games", icon: "solar:gamepad-old-bold" },
  { href: "/schools", label: "Schools", icon: "solar:buildings-2-bold" },
  { href: "/county", label: "County", icon: "solar:map-point-bold" },
  { href: "/district", label: "District", icon: "solar:buildings-bold" },
  { href: "/report", label: "Report", icon: "solar:document-text-bold" },
];
